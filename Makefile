...
RAWFILES	:=	$(foreach dir,$(AUDIO),$(notdir $(wildcard $(dir)/*.raw)))
...
export OFILES_AUDIO := $(RAWFILES:.raw=.o)

export OFILES := $(OFILES_BIN) $(OFILES_SOURCES) $(OFILES_GRAPHICS) $(OFILES_AUDIO)

export HFILES := $(addsuffix .h,$(subst .,_,$(BINFILES))) $(PNGFILES:.png=.h) $(RAWFILES:.raw=.h)
...
#---------------------------------------------------------------------------------
# This rule creates sources files from the raw audio files using raw2gba
#---------------------------------------------------------------------------------
%.h: %.raw
#---------------------------------------------------------------------------------
	@echo "raw2gba $(notdir $<)"
